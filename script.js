async function searchResults(keyword) {
    try {
        ...
        const responseText = await soraFetch(`https://api.themoviedb.org/3/search/tv?api_key=f3d757824f08ea2cff45eb8f47ca3a1e&query=${encodedKeyword}&language=fr-FR&page=1&include_adult=false&sort_by=popularity.desc`);
